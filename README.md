...
![Category](https://img.shields.io/badge/Focus-E--commerce%20%26%20Events-orange.svg)

**pro-cyclical-clock** es un motor de temporizadores recurrentes para WordPress desarrollado por [Abstracta digital](https://abstracta.digital/). A diferencia de las cuentas atrás estándar, este plugin está diseñado para automatizar ciclos de tiempo que se repiten periódicamente (diarios, semanales o mensuales).
...
* **Lanzamientos Periódicos:** Configura un temporizador que se reinicie cada lunes a las 09:00 para la subida de nuevos productos.
* **Ofertas Flash Diarias:** Establece una cuenta atrás que comience cada día a las 09:00 y termine a las 21:00 automáticamente.
...
* **Uso mediante Shortcode:** Implementación sencilla en cualquier parte de tu web con `[pro_cyclical_clock]`.
...
👉 **[Descargar en Abstracta digital](https://abstracta.digital/)**

### 2. Instalación en WordPress
1. Descarga el archivo `.zip` de este repositorio (o desde nuestra web).
...
---
Hecho con estrategia y código por **Abstracta digital**.
